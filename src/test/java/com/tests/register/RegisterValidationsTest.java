...
public class RegisterValidationsTest extends BaseTest {
	...
	public void verifyExistingEmailShowsError() {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div.message-error.validation-summary-errors li")));
		Assert.assertEquals(driver.findElement(By.cssSelector("div.message-error.validation-summary-errors li")).getText(), 
